...
public class LoginViewModel extends ViewModel {
    private String email = "riofebrina@gmail.com";
    private String password = "riofebrian";
    ...
    public void doLogin() {
        ...
        if (login.email.equals(email) && login.password.equals(password)) {
            ...
            EmailAddress.setValue("Email Salah!, Masukkan alamat email Anda dengan benar");
            Password.setValue("Password Salah!, Masukkan password Anda dengan benar");
            loggedMutableLive.setValue(false);
            return;
        }
